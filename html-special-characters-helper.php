...
class c2c_HTMLSpecialCharactersHelper {
	...
	/**
	 * Actions triggered on 'init'.
	 */
	public static function do_init() {
		load_plugin_textdomain( 'c2c_hsch', false, basename( __DIR__ ) . DIRECTORY_SEPARATOR . 'lang' );
	}
	...
	public static function get_default_html_special_characters( $category = null ) {
		if ( ! self::$characters ) {
			...
			self::$characters = array(
				'common' => array(
					'name'     => __( 'Most commonly used', 'c2c_hsch' ),
